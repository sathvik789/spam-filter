...
try
{
    ...
    String qry="select * from swords where sno='"+id+"' ";
...
%>
			...
			<tr > 
              <td align="right"><font size="+2" color="#ff0066"><font size="+2" color="#ff0066"><strong>S. No:</strong></font></td> <td ><%=sno%> <input type="hidden" name="sno" value=<%=sno%>>
			   ...
			   <tr> <td align="right"> <font size="+2" color="#ff0066"><strong>Spam Word</strong></font></td><td >			<div class="user"><input type="text" name="domian" value= "<%=domain%>" > </td></tr></div>
