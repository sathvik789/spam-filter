...
<%@ page  import="java.sql.*" import="databaseconnection.*"%>
		...
		{
			out.println("<script>alert('Spam Word Diplicate')</script>");
		}

		if(request.getParameter("msg")!=null)
		{
			out.println("<script>alert('Spam Word Updated Successfully')</script>");
		}
		if(request.getParameter("msg1")!=null)
		{
			out.println("<script>alert('Spam Word Deleted Successfully')</script>");
		}
		%>
		<form>

<font size="+3" color="#e75314">List Of Spam Words</font>
<center>
          <table bgcolor="" cellpadding="20" cellspacing="5" width="500" border="0" align="center">
            ...
            <tr bgcolor="  #f5ab96"> 
			  ...
			  <td align="center"><font color="#110022"><strong>Spam Words</strong></font></td>
...
%>
            <tr bgcolor="#d2d2d2"> 
              ...
              <td align="center"><strong><font size="3" color="#FF3300"> <%=domain%> </font></strong></td>
				  ...
				  <td align="center"><a href="supdate.jsp?id=<%=sno%>"><strong><font color="#6300C6" class="big"> 
                Update</font></strong></a></td>
				  <td align="center"><a href="sdelete.jsp?id=<%=sno%>"><strong><font color="#6300C6" class="big"> 
 ...
 %>
		...
		<form method="post" action="swordadd.jsp">
          <table bgcolor="" cellpadding="20" cellspacing="5" width="500" border="0" align="center">
