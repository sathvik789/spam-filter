...
rs1 = stmt1.executeQuery("SELECT * FROM compose WHERE email='"+from_mail+"'  and mstatus='inbox'  OR cc='"+from_mail+"' OR bcc='"+from_mail+"'  " );
...
<tr>
	...
	<td ><a href="view.jsp?id=<%=rs1.getString("id")%>"><font size="4" color="#4d7abf"><%=rs1.getString("frommail")%></a><font></td>
	<td ><a href="view.jsp?id=<%=rs1.getString("id")%>"><font size="4" color="#939393"><b><%=rs1.getString("SUBJECT")%><font></a></td></b>
